length = len("Happy Cat")   # len function that takes a string and returns the number of characters
# "Happy Cat" is the argument that len function took, it returned the value 9
...
print(mystery)      # print returns nuthing (None)
...
print(round(34.6766876, 2))
print(round(34.6766876)) # round(34.6766876) same as rounding to an int